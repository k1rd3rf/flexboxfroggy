var docs = {
  'align-content': {
    ...
    'no': '<p>Juster flex-konteinerens linjer innenfor flex-konteineren når det er ekstra mellomrom i tverraksen.</p><code>flex-start</code> <code>flex-end</code> <code>center</code> <code>space-between</code> <code>space-around</code> <code>stretch</code>',
  ...
  'align-items': {
    ...
    'no': '<p>Juster flex-elementer langs tverraksen.</p><code>flex-start</code> <code>flex-end</code> <code>center</code> <code>baseline</code> <code>stretch</code>',
  ...
  'align-self': {
    ...
    'no': '<p>Justerer et flex-element langs tverraksen, ved å overstyre verdien på <code>align-items</code>.</p><code>flex-start</code> <code>flex-end</code> <code>center</code> <code>baseline</code> <code>stretch</code>',
  ...
  'flex-direction': {
    ...
    'no': '<p>Definerer retningen på hovedaksen.</p><code>row</code> <code>row-reverse</code> <code>column</code> <code>column-reverse</code>',
  ...
  'flex-flow': {
    ...
    'no': '<p>Kortversjon for egenskapene <code>flex-direction</code> og <code>flex-wrap</code>.</p><code>&lt;flex-direction&gt; &lt;flex-wrap&gt;</code>',
  ...
  'flex-wrap': {
    ...
    'no': '<p>Angir om flex-elementer blir tvunget på en linje eller kan kveiles på flere linjer.</p><code>nowrap</code> <code>wrap</code> <code>wrap-reverse</code>',
  ...
  'justify-content': {
    ...
    'no': '<p>Justerer flex-elementer langs hoveraksen.</p><code>flex-start</code> <code>flex-end</code> <code>center</code> <code>space-between</code> <code>space-around</code>',
  ...
  'order': {
    ...
    'no': '<p>Angir rekkefølgen på et flex-element.</p><code>&lt;integer&gt;</code>',
